                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                id="special_price"
                                                name="special_price"
                                                value="{{ old('special_price', $product->discount_price) }}"
                                            />
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        @if ($product->image != null)
                                            <div class="col-md-2">
                                                <figure class="mt-2" style="width: 80px; height: auto;">
                                                    <img src="{{ asset('storage/media/product/'.$product->image) }}" id="brandLogo" class="img-fluid" alt="img">
                                                </figure>
                                            </div>
                                        @endif
                                        <div class="col-md-10">
                            ...
                            <div class="tile-footer">
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        ...
                                        <a class="btn btn-danger" href="{{ route('panel.products.index') }}"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Go Back</a>
                                    </div>
                                </div>
                            </div>
                        </form>
...
@endsection
@push('scripts')
    <script type="text/javascript" src="{{ asset('panel/js/plugins/select2.min.js') }}"></script>
    <script>
